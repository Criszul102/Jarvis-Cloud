...
async def responder(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    completion = client.chat.completions.create(
        ...
        messages=[{"role": "system", "content": "Eres Jarvis, el asistente de Tony Stark. Hablas con toque colombiano."},
...
if __name__ == '__main__':
    # Lanzamos el servidor de mentira para Render
